                    ...
                    <div class="card-body" style="max-height: 80vh; overflow-y: auto;"> <!-- Container Scrollable -->
                        ...
                        <form action="{{ route('teacher.update', $teacher->id) }}" method="POST" enctype="multipart/form-data" onsubmit="confirmUpdate(event)">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="jabatan" name="jabatan" value="{{ $teacher->jabatan }}" required>
                            </div>

                            <div class="mb-3">
                                <label for="addres" class="form-label">Alamat</label>
                                <textarea class="form-control" id="addres" name="addres" required>{{ $teacher->addres }}</textarea>
                            </div>
                           ...
                           <div class="mb-3">
                                ...
                                @if($teacher->photo)
                                    <img id="previewImage" src="{{ asset('storage/teacher/' . $teacher->photo) }}" class="img-thumbnail" width="150">
                                @else
