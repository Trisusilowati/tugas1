                            ...
                            <form action="{{ route('teacher.update', $teacher->id) }}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="jabatan" name="jabatan"
                                        value="{{ $teacher->jabatan }}" required>
                                </div>

                                <div class="mb-3">
                                    <label for="addres" class="form-label">Alamat</label>
                                    <textarea class="form-control" id="addres" name="addres"
                                        required>{{ $teacher->addres }}</textarea>
                                </div>

                                <div class="mb-3">
                                    <label for="gender" class="form-label">Jenis Kelamin</label>
                                    <select class="form-control" id="gender" name="gender" required>
                                        <option value="male" {{ $teacher->gender == 'male' ? 'selected' : '' }}>Laki-laki
                                        </option>
                                        <option value="female" {{ $teacher->gender == 'female' ? 'selected' : '' }}>Perempuan
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="status" name="status" required>
                                        <option value="active" {{ $teacher->status == 'active' ? 'selected' : '' }}>Aktif
                                        </option>
                                        <option value="inactive" {{ $teacher->status == 'inactive' ? 'selected' : '' }}>Tidak
                                            Aktif</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($teacher->photo)
                                        <img id="previewImage" src="{{ asset('storage/teacher/' . $teacher->photo) }}"
