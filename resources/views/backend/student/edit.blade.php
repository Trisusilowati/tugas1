                            ...
                            <form action="{{ route('students.update', $student->id) }}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="addres" name="addres"
                                        required>{{ $student->addres }}</textarea>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="status" name="status" required>
                                        ...
                                        <option value="inactive" {{ $student->status == 'inactive' ? 'selected' : '' }}>Tidak
                                            Aktif</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($student->photo)
                                        <img id="previewImage" src="{{ asset('storage/students/' . $student->photo) }}"
